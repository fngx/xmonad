...
instance Default Theme where
  def =
    Theme { activeColors = Colors "#999999" "#FFFFFF" "#FFFFFF"
          , inactiveColors = Colors "#666666" "#BBBBBB" "#BFBFBF"
          , urgentColors = Colors "#FFFF00" "#00FF00" "#FF0000"
...
createDecoWindow t r = let mask = Just (exposureMask .|. buttonPressMask) in
                       createNewWindow r mask ((bgColor . inactiveColors) t) True
